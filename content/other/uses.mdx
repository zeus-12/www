...
- Other
  ...
  - Superwhisper: for fast, local audio to text conversion
  - ProNotes: extend apple notes
  - 20-20-20: for eye strain
  - Pure Paste: to remove tracking links, etc.
  - Alcove: dyanmic island kinda ui for mac
