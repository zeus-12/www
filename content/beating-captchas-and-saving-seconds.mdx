...
One of the hardest (and most fun) problems I’ve solved was during the second week of my internship at [Commenda](https://www.commenda.io/) (summer '23). The product lead casually mentioned there was an ongoing bounty, open for a few months, and asked if I wanted to take a shot. I said sure, not really knowing what I was getting into.
...
For context, the Delaware site took around 6.5 seconds to fully load in a browser (tested at the time of writing this, from my home in [Kozhikode, India](https://www.google.com/search?q=Kozhikode)). But now, we were pulling the needed data in just 2 seconds.
