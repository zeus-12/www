...
Also I really want to build a proper offline document tts. I’ve been using [https://www.paper2audio.com/](https://www.paper2audio.com/) a bit and it’s v nice. Something similar, but with pdf highlighting w tts instead of the plain text version.
