...
This started bothering me back in my first year. I really wanted a better way to study. I'm someone obsessed w finding the right tool for every little task (if you're curious, [here's my whole setup](/posts/uses)). I tried every PDF reader app I could find. The closest I got to what i wanted was [Highlights](https://highlightsapp.net). Clean UI, worked really well. But a lot of important features were behind a paywall, and most of the other decent web / electron apps used a library called `react-pdf`, which has this [really annoying bug](https://github.com/wojtekmaj/react-pdf/issues/101) (super cool lib except for this 1 issue).
