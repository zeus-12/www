...
<div className="justify-center flex">
  <span className="text-muted-foreground">In apps using `react-pdf` library</span>
</div>
...
We called it Uxie, named after the [_knowledge_ pokémon](https://www.pokemon.com/us/pokedex/uxie). (credit to [t3dotgg](https://x.com/theo) for the idea of naming side projects after pokémon. i don’t know a thing about pokémon, but i love this way of naming things haha)
...
<div className="justify-center flex">
  <span className="text-muted-foreground">Demo video we built for the event (ps: this has changed a lot since then.)</span>
</div>
