...
<div className="mt-1 flex flex-col">
  <span className="text-center text-muted-foreground">
    {
      "In apps using the react pdf library (left), dragging a text selection slightly outside the paragraph selects all text on that page, this doesn't happen in uxie (right)."
    }
  </span>
</div>
