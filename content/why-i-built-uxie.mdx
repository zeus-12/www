...
This started bothering me back in my first year. I really wanted a better way to study. I'm someone obsessed with finding the right tool for every little task (if you're curious, [here's my whole setup](/blog/uses)). I tried every PDF reader app I could find. The closest I got to what I wanted was [Highlights](https://highlightsapp.net). Clean UI, worked really well. But a lot of useful features were behind a paywall, and most of the other decent web / electron apps used a library called `react-pdf`, which has this [really annoying bug](https://github.com/wojtekmaj/react-pdf/issues/101) (super cool lib except for this 1 issue).
...
As a result, shipped AI powered text-to-speech models running locally on webgpu with _much_ better voice quality, [bionic reading](https://www.reddit.com/r/BeAmazed/comments/11jy27e/bionic_reading_method/) mode, [rsvp reading](https://x.com/iruletheworldmo/status/2011411177843085343) mode, a "read-along" speech helper kind of tool that does TTS but in reverse, it'd highlights a word, uses local speech-to-text models, and only moves forward when the user says it correctly (also showing meaning / pronounciations / audio of it), helping users with reading and pronunciation, and a bunch of other cool stuff.
...
<Quote text="To make a product people love, you have to obsessively use it yourself. Deeply, properly, every single day." />

I live by that. I’ve had tons of ideas in the past and even worked on a few, but
nothing really stuck. This did, because it’s a problem i (and many people i know) keep facing.

That’s also where I feel a bit stuck now. I can’t, for the life of me, come up with a new idea I care about as much as uxie. Lately it’s started to feel like maybe the era of “just building another app” is fading. With ai getting this good, I keep coming back to the idea of [personal software](https://leerob.com/personal-software): small, oddly specific tools that solve very real problems in your own life, maybe a tiny “one second everyday” memory thing (like [this](https://www.youtube.com/watch?v=Ka-miwm-7to)), something super creative & fun.
...
> Update: i actually went and built the desktop version. embeddings & storage all on device, inference running off my claude subscription. wrote about it [here](/blog/the-agent-coding-rabbit-hole#uxie-on-desktop).

Also I really want to build a proper offline document tts. I’ve been using [Paper2Audio](https://www.paper2audio.com/) a bit and it’s v nice. Something similar, but with pdf highlighting w tts instead of the plain text version.
